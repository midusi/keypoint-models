...
from type_hints import Box, KeypointData, T
...
#def interpolate_keypoints(keypoints: list[KeypointData]):
#    keypoints_each = [[] for _ in range(int(len(keypoints[0]['keypoints'])/3))]
